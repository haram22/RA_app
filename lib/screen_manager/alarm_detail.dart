            ...
            child: ListBody(
              children: ListTile.divideTiles(
                ...
                tiles: [
                  ...
                  ListTile(
                    leading:
                        Text('알림 구분', style: TextStyle(color: Colors.grey)),
                    title: Text('설비 시스템'),
                  ),
                  ListTile(
                    leading:
                        Text('알림 명칭', style: TextStyle(color: Colors.grey)),
                    title: Text('냉동 창고 3호'),
                  ),
                  ListTile(
                    leading:
                        Text('알림 메시지', style: TextStyle(color: Colors.grey)),
                    title: Text('온도 상승 경고,원인 확인 및 조치내역을 등록하세요.',
